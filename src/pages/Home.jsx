  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Discover top career opportunities with Zobly's AI-powered job search engine. Get resume analysis, personalized cover letters, and smart job matching across Naukri, Glassdoor, and more."
        />
        <meta
          name="keywords"
          content="AI job search, resume optimization, career growth, job matching platform, employment opportunities, resume builder, cover letter generator, job alerts, recruitment platform, hiring solutions, job listings, career portal, professional development, job application tips, smart job search"
        />
        <link rel="canonical" href="https://zobly.com" />
        <meta
          property="og:title"
          content="Zobly - AI-Powered Career Platform & Job Matching Engine"
        />
        <meta
          property="og:description"
          content="Transform your job search with intelligent resume analysis and AI-driven career recommendations. Find perfect job matches across top platforms."
        />
        ...
        <meta
          name="twitter:title"
          content="Zobly - Smart Job Search & Career Development Platform"
        />
        <meta
          name="twitter:description"
          content="Leverage AI for smarter job applications and career growth. Get matched with ideal opportunities and optimize your job search strategy."
        />
        <meta
          name="twitter:image"
          content="https://zobly.com/twitter-image.jpg"
        />
      </Helmet>
